...
describe StackBuilder::Chef do
    ...
    before(:all) do
        ...
        # Local vagrant host on which Chef Zero is running
        Chef::Config[:chef_server_url] = "http://192.168.50.1:9999"
    end
    ...
    it "should build the DEV stack" do
    ...
    it "should scale the DEV stack" do
